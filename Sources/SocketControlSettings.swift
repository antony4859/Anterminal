...
enum SocketControlPasswordStore {
    static let service = "com.anterminal.app.socket-control"
...
struct SocketControlSettings {
    ...
    static let baseDebugBundleIdentifier = "com.anterminal.app.debug"
    ...
    static func defaultSocketPath(bundleIdentifier: String?, isDebugBuild: Bool) -> String {
        if bundleIdentifier == "com.anterminal.app.nightly" {
    ...
    static func isDebugLikeBundleIdentifier(_ bundleIdentifier: String?) -> Bool {
        ...
        return bundleIdentifier == "com.anterminal.app.debug"
            || bundleIdentifier.hasPrefix("com.anterminal.app.debug.")
    }

    static func isStagingBundleIdentifier(_ bundleIdentifier: String?) -> Bool {
        guard let bundleIdentifier else { return false }
        return bundleIdentifier == "com.anterminal.app.staging"
            || bundleIdentifier.hasPrefix("com.anterminal.app.staging.")
    }
