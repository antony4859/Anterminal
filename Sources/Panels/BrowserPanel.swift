...
func normalizedBrowserHistoryNamespace(bundleIdentifier: String) -> String {
    if bundleIdentifier.hasPrefix("com.anterminal.app.debug.") {
        return "com.anterminal.app.debug"
    }
    if bundleIdentifier.hasPrefix("com.anterminal.app.staging.") {
        return "com.anterminal.app.staging"
    }
